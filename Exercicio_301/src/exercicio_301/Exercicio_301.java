...
public class Exercicio_301 {
    ...
    public static void main(String[] args) {
        ...
        //Inicio do programa
        System.out.println("=============================================");
        System.out.println("FAZ A GESTAO DE RENDA DE ALUNOS DE UMA FACULDADE.");
        ...
        while (renda_pessoal > 0){
            ...
            if (resposta == 'S'){
                ...
                if (renda_pessoal >0.0){
                    ...
                    System.out.print("Informe a despesa de alimentacao: R$");
                    ...
                    porcentagem_gastos = (100 * (despesa_alimentacao + 
                            despesa_outras))/(renda_familiar + renda_pessoal);
                    System.out.println("A porcentagem de gastos do aluno: "+ 
                            porcentagem_gastos+"%.");
                }else{
                    System.out.println("A renda pessoal e menor ou igual a 0.");
                }
            System.out.println("=============================================");
            }else{
                break;
        ...
        if (alunos>0){
            ...
            System.out.println(pessoal_maior_familiar+
                    " alunos que tem renda pessoal maior que renda familiar.");
        }else{
